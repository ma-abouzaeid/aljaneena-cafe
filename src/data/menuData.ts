...
export const menuCategories: MenuCategory[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { id: 'c14', name: 'بيبسي', price: 25 },
      { id: 'c15', name: 'سيفن', price: 25 },
      { id: 'c16', name: 'ميرندا برتقال', price: 25 },
      { id: 'c17', name: 'فيروز', price: 30 },
      { id: 'c18', name: 'بيرل', price: 30 },
      { id: 'c19', name: 'فيوري', price: 30 },
      { id: 'c20', name: 'تويست توت', price: 25 },
      { id: 'c21', name: 'تويست فراوله', price: 25 },
    ],
  },
  {
    id: 'shisha',
